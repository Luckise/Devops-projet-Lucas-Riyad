    ...
    <main className="min-h-screen text-white pb-24 pt-[80px]">
      <div className="max-w-md mx-auto px-4 pt-4 md:pt-8">
        <header className="mb-8">
          <p className="text-white/60 text-xs font-bold uppercase tracking-[0.2em] mb-1.5 ml-0.5">
            Account
          </p>
          <h1 className="text-[2.5rem] font-serif font-medium tracking-tight leading-none">
            Profile
          </h1>
        </header>
        ...
        <div className="space-y-2">
          {[
            ...
            <button
              key={i}
              className="w-full flex items-center gap-4 p-4 rounded-2xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/5 text-left"
            >
